...
const Sidebar = ({ handleAdd, section, setSection, theme, handleTheme }) => {
    return (
        <div className="sidebar">
            ...
            <button className="create-note" onClick={handleAdd}>
